...
//     to: "support@Piccasee.com ", // list of receivers
...
const sendWelcomeEmail = async ({ to, token }) => {
  ...
  let info = await transporter.sendMail({
    ...
    html: `
    <html>
    <h2>Welcome to Piccasee! We’re thrilled to have you join our community.
</h2>
...
<p>If you need any assistance, our support team is here to help. Dive in and discover the future of luxury with Piccasee!
    </p>
    <p>Best wishes,</p>
    <p>Piccasee Team</p>
